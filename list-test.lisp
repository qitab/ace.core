...
(deftest unordered-equal-test ()
  (declare (notinline list:unordered-equal))
  (expect (list:unordered-equal '() '()))
  (expect (not (list:unordered-equal '() '(1))))
  (expect (not (list:unordered-equal '(1) '())))
  (expect (list:unordered-equal '(1) '(1)))
  (expect (list:unordered-equal '(1 2) '(1 2)))
  (expect (list:unordered-equal '(1 2) '(2 1)))
  (expect (list:unordered-equal '(1 2 1) '(2 1 1)))
  (expect (not (list:unordered-equal '(1 2) '(1 2 1))))
  (expect (list:unordered-equal '(1 2 3 x 4 y) '(y 3 2 x 4 1)))
  (expect (list:unordered-equal '((1 . 2) (1 . 3) (2 . 1))
                                '((1 . 4) (1 . 2) (2 . 7))
                                :key #'car))
  (expect (not (list:unordered-equal '((1 . 2) (1 . 3) (2 . 1))
                                     '((1 . 4) (1 . 2) (2 . 7))
                                     :key #'cdr)))
  (expect (not (list:unordered-equal '("abc" "def") (list (copy-seq "def") "abc"))))
  (expect (list:unordered-equal '("abc" "def") (list (copy-seq "def") "abc") :test #'equal))
  (expect (list:unordered-equal '("abc" "def") '("DEF" "ABC") :test #'equalp)))
...
(deftest unionf-test ()
  (let ((a (list 1 2)))
    (expect (list:unordered-equal '(1 2 3 4) (list:unionf a (list 1 3 4))))
    (expect (list:unordered-equal '(1 2 3 4) a))))

(deftest intersectionf-test ()
  (let ((a (list 1 2 3)))
    (expect (list:unordered-equal '(1 2) (list:intersectionf a (list 1 2 4))))
    (expect (list:unordered-equal '(1 2) a))))
